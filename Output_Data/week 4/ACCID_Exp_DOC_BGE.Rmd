...
```{r}
excel_sheets("~/Desktop/GITHUB/144l_students/Input_Data/week4/ACIDD_Exp_TOC.xlsx")
metadata <- read_excel("~/Desktop/GITHUB/144l_students/Input_Data/week4/ACIDD_Exp_TOC.xlsx", sheet = "Metadata")
data <- read_excel("~/Desktop/GITHUB/144l_students/Input_Data/week4/ACIDD_Exp_TOC.xlsx", sheet = "Data")
```
...
```{r}
bc <- read_rds("~/Desktop/GITHUB/144l_students/Output_Data/week3/ACCID_Exp_Processed_BactAbund.rds")
...
```{r}
saveRDS(averages, "Output_Data/week 4/ACCID_EXP_Processed_DOC_BGE.rds")
```   
